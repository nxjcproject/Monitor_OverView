                            ...
                            <table>
                                <tr>
                                    ...
                                    <td  style="width: 110px;">
                                        <select id="ComboTree_StandardF" class="easyui-combotree" name="ValueType" data-options="panelHeight:'auto'" style="width: 100px;">
                                        </select>
                                    </td>
                                    <th style="width: 60px;">主要设备</th>
                                    <td style="width: 70px;">
                                        <select id="Combobox_EquipmentCommonF" class="easyui-combobox" name="Combobox_EquipmentCommonF" data-options="panelHeight:'auto', editable:false, valueField: 'EquipmentCommonId',textField: 'Name', onSelect:function(myRecord){LoadSpecifications(myRecord.EquipmentCommonId);}" style="width: 60px;"></select>
                                    </td>
                                    <th style="width: 60px;">规格型号</th>
                                    <td style="width: 70px;">
                                        <select id="Combobox_SpecificationsF" class="easyui-combobox" name="Combobox_SpecificationsF" data-options="panelHeight:'auto', editable:false, valueField: 'id',textField: 'text'" style="width: 60px;"></select>
                                    </td>
                                    <td style="width: 60px;">
                                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true"
